...
from ..hooks.ClavisHook import ClavisHook
...
class ClavisToS3Operator(BaseOperator):
    ...
    :param clavis_endpoint: The endpoint to retreive data for. Possible
        values are: [kpi, products, search_terms, content]
    ...
    :param payload: Payload variables -- all are optional
        ...
        :param report_date: The requested date to return a
            single days data for (Format: yyyy-mm-dd eg. 2017-04-10).
            Used for Products, Search Terms, and Content endpoints.
        ...
        :param brand: Filter the response data by a comma separated
            list of manufacturer brands.
        :type brand: string
        :param category: Filter the response data by a comma separated
        list of manufacturer categories.
        :type category: string
        :param include_competitor_data: Indicates whether the response
            should include competitor data. This is turned off by default.
    ...
    :param s3_bucket: The S3 bucket to be used to store the Clavis data.
    :type s3_bucket: string
    :param s3_key: The S3 key to be used to store the Clavis data.
    :type s3_bucket: string
    """

    template_fields = ['payload', 's3_key']
